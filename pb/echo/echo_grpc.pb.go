...
func (c *echoServerClient) Echo(ctx context.Context, in *Echodata, opts ...grpc.CallOption) (*Echodata, error) {
	out := new(Echodata)
...
func (UnimplementedEchoServerServer) Echo(context.Context, *Echodata) (*Echodata, error) {
...
func _EchoServer_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServerServer).Echo(ctx, req.(*Echodata))
	}
